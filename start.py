...
def get_stock_list():
    ...
    for market in ["KOSPI", "KOSDAQ"]:
        ...
        while len([r for r in rows if r['Market'] == market]) < max_stocks:
            params = {
                "serviceKey": API_KEY,
                "numOfRows": "2000",
                "pageNo": str(page),
    ...
    df_kospi = df[df['Market'] == 'KOSPI'].head(500)
    df_kosdaq = df[df['Market'] == 'KOSDAQ'].head(1000)
